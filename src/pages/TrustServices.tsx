...
import { Bot, Workflow, MessageSquare, Zap, TrendingUp, DollarSign, Shield, ArrowRight, Sparkles, Network } from 'lucide-react';
...
export default function TrustServices({ onNavigate }: TrustServicesProps) {
