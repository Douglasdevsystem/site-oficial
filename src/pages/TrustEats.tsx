...
import { UtensilsCrossed, MessageSquare, QrCode, LayoutGrid, TrendingUp, CheckCircle, Clock, Star, ArrowRight, Sparkles } from 'lucide-react';

type Page = 'home' | 'trust-services' | 'trust-eats';

interface TrustEatsProps {
  onNavigate: (page: Page) => void;
}

export default function TrustEats({ onNavigate }: TrustEatsProps) {
